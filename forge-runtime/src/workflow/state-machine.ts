...
const LEGAL_TRANSITIONS: Record<WorkflowStage, readonly WorkflowStage[]> = {
	...
	USER_CONFIRMED: ["GRILL", "LIGHT_DISCOVERY", "DEEP_KNOWLEDGE_RETRIEVAL"],
	DEEP_KNOWLEDGE_RETRIEVAL: ["KNOWLEDGE_UNDERSTANDING"],
	KNOWLEDGE_UNDERSTANDING: ["CONTEXT_BUILD"],
	CONTEXT_BUILD: ["ADR_BUILD"],
	ADR_BUILD: ["TO_SPEC"],
	TO_SPEC: ["TO_TICKET"],
	TO_TICKET: ["PLANNING"],
